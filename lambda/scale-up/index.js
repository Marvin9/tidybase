...
export const handler = async (event) => {
  try {
    ...
    await checkInstancesHealth(BigAutoScalingName);

    await registerAsgToTargetGroup(BigAutoScalingName, TargetGroupArn);

    await waitForHealthyInstances(BigAutoScalingName, TargetGroupArn);

    await deregisterAsgFromTargetGroup(TinyAutoScalingName, TargetGroupArn);
